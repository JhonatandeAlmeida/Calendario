                ...
                try:
                    ...
                    st.markdown(
                        ...
                        <div style="
                            ...
                            margin-bottom: 10px;
                        ">
                            <img src="data:image/png;base64,{img_base64}" style="width: 110px; max-width: 100%;">
                        </div>
                        """,
                        unsafe_allow_html=True
                    )
...
with colf1:
    st.markdown(
        "<div style='font-size:15px;font-weight:bold;margin-bottom:5px'>          Mês</div>",
        unsafe_allow_html=True
    )
with colf2:
    mes = st.selectbox(
...
with colf3:
    st.markdown(
        "<div style='font-size:15px;font-weight:bold;margin-bottom:5px'>          Tipo</div>",
        unsafe_allow_html=True
    )
with colf4:
    negocios = sorted(
...
with colf5:
    st.markdown(
        "<div style='font-size:15px;font-weight:bold;margin-bottom:5px'>          UF</div>",
        unsafe_allow_html=True
    )
with colf6:
    regionais = sorted(
...
with colf7:
    st.markdown(
        "<div style='font-size:15px;font-weight:bold;margin-bottom:5px'>     Canal</div>",
        unsafe_allow_html=True
    )
with colf8:
